...
const CreateQuestionPartFour = () => {
  ...
  const onFinish = async (values) => {
    values.partFourId = _id
    values.imageUrl = avatar
    setIsLoading(true)
    try {
      const response = await axios.post(Summary.postQuestionPartFour.url, values, {
        headers: {
...
export default CreateQuestionPartFour
